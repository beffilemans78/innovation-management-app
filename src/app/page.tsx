...
export default async function Home() {
  ...
  return <AppShell title="Guten Tag">
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {modules.map((module, index) => <section key={module} className="group rounded-2xl border border-white/10 bg-[#061c25]/88 p-5 text-slate-100 shadow-[0_18px_60px_rgba(0,0,0,0.2)] transition duration-300 hover:-translate-y-1 hover:border-sky-300/25 hover:bg-[#061c25]/94">
