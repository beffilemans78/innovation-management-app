...
export function AppShell({ title, children }: { title: string; children: ReactNode }) {
  return (
    <div className="relative isolate min-h-screen overflow-hidden bg-[#020817] text-slate-950">
      <DnaBackground className="-z-20" />
      <div className="relative z-10 flex min-h-screen flex-col">
        <header className="border-b border-white/10 bg-[#041022]/65 text-slate-100 backdrop-blur-xl">
